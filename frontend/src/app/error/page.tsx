...
const ServerError = () => {
  return (
    <div className="bg-white h-[450px] mt-[40px] container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
      <h1 className="text-red-600 text-5xl font-bold text-center my-8 sm:text-4xl md:text-5xl lg:text-4xl xl:text-5xl">
        500 ERROR
      </h1>
      <div className="bg-white w-4/5 h-auto p-4 border border-gray-300 rounded-lg">
        <h2 className="text-red-600 text-xl leading-snug mb-4 sm:text-base md:text-xl lg:text-base xl:text-xl">
        ...
        <div className="flex flex-row w-full h-6 mb-4">
          <svg
            className="w-3 h-3 self-center sm:w-2.5 sm:h-2.5"
          ...
          <p className="ml-2 inline-block w-4/5 text-base leading-normal">
            Refresh the page
          </p>
        </div>
        <div className="flex flex-row w-full h-6 mb-4">
